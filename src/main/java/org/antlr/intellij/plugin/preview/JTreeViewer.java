...
public class JTreeViewer extends JPanel {
	...
	private void setupTree(Tree tree) {
		...
		renderer.setOpenIcon(TargetAWT.to(Icons.PARSER_RULE));
		renderer.setClosedIcon(TargetAWT.to(Icons.PARSER_RULE));
		renderer.setLeafIcon(TargetAWT.to(Icons.LEXER_RULE));
